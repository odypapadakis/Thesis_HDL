...
#
#      ncsim -cdslib /localdisk/users/papadako/diplomatiki/A_HDL/Arbitration_submodule/1_SIMVISION/cds.lib -logfile ncsim.log -errormax 15 -status worklib.ArbitrationSubModule_Testbench:module -tcl -update -input /localdisk/users/papadako/diplomatiki/A_HDL/Arbitration_submodule/1_SIMVISION/restore2.tcl
#
